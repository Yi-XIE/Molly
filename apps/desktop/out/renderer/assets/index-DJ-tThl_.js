...
function SearchIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "11", cy: "11", r: "6.7" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m16 16 4 4" })
  ] });
}
function PlusIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 5v14M5 12h14" }) });
}
function StopIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "7", y: "7", width: "10", height: "10", rx: "1.5" }) });
}
function ArrowIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5 12h13M14 7l5 5-5 5" }) });
}
function ExternalIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M14 5h5v5M19 5l-8 8" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M18 13v5a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h5" })
  ] });
}
function MollyCore({ status = "idle", small = false }) {
  const active = status === "running" || status === "queued";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `molly-core ${small ? "small" : ""} ${active ? "is-active" : ""}`, "aria-label": "Molly 状态", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core-halo halo-one" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core-halo halo-two" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "core-orbit", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core-seed" })
  ] });
}
function TaskItem({ task, selected, onSelect }) {
  const copy = STATUS_COPY[task.status];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: `task-item ${selected ? "selected" : ""}`, onClick: onSelect, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status-dot ${copy.tone}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "task-item-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: task.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: copy.label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("time", { children: timeLabel(task.updatedAt) })
  ] });
}
function EmptyConversation({ onPrompt }) {
  const prompts = ["整理一下我今天的想法", "回顾最近的成长变化", "帮我研究一个产品问题"];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-conversation", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MollyCore, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "MOLLY · PERSONAL NODE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "今天想一起完成什么？" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "empty-lead", children: "想法可以很模糊。你说出来，我会陪你把它变成行动与产物。" }),
...
function Conversation({ snapshot, streaming }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "conversation-scroll", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-stack", children: [
      messages.map((message) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `message ${message.role}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-author", children: message.role === "user" ? "Yi" : message.role === "assistant" ? "Molly" : "系统" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-body", children: message.content }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("time", { children: timeLabel(message.createdAt) })
      ] }, message.id)),
      streaming && task.status === "running" && /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "message assistant streaming", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-author", children: "Molly" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-body", children: [
          streaming,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "caret" })
        ] })
      ] }),
      task.status === "running" && !streaming && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "working-line", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MollyCore, { status: "running", small: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: latestEvent?.summary ?? "正在思考" })
      ] }),
      task.lastError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-error", children: task.lastError })
    ] })
  ] });
}
...
function ArtifactPanel({ snapshot }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "artifact-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-heading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "OUTCOME" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "产物" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "artifact-count", children: artifacts.length })
    ] }),
    artifacts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "artifact-tabs", children: artifacts.map((artifact) => /* @__PURE__ */ jsxRuntimeExports.jsx(ArtifactCard, { artifact, active: selected?.id === artifact.id, onSelect: () => setSelectedId(artifact.id) }, artifact.id)) }),
      selected && /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "artifact-preview", children: [
        ...
        selected.previewText ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "preview-text", children: selected.previewText }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "preview-placeholder", children: "产物已经准备好，可以在原位置打开。" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: snapshot ? "产物正在形成" : "产物会出现在这里" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: snapshot ? snapshot.events.at(-1)?.summary : "文档、研究结果和行动卡会留在右侧，随时可以回来继续。" })
    ] }),
    snapshot && snapshot.events.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activity-strip", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow", children: "ACTIVITY" }),
      snapshot.events.slice(-4).reverse().map((event) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activity-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: event.summary }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("time", { children: timeLabel(event.occurredAt) })
      ] }, event.id))
    ] })
  ] });
}
function App() {
  ...
  const selectTask = reactExports.useCallback(async (taskId) => {
    const version = ++selectionVersion.current;
    setSelectedId(taskId);
    const next = await window.molly.getTask(taskId);
  ...
  reactExports.useEffect(() => window.molly.onTaskEvent((event) => {
  ...
  const beginNew = reactExports.useCallback(() => {
  ...
  const activeCount = reactExports.useMemo(() => tasks.filter((task) => ["queued", "running", "waiting_input"].includes(task.status)).length, [tasks]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: `app-shell ${sidebarOpen ? "" : "sidebar-collapsed"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grain" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "titlebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "brand", onClick: beginNew, "aria-label": "Molly 首页", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MollyCore, { small: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Molly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "和 Yi 一起成长" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "node-light" }),
        "个人节点在线 · ",
        runtimeLabel
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "window-space" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "task-sidebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-toolbar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "collapse-button", onClick: () => setSidebarOpen((open) => !open), "aria-label": "收起任务中心", children: "◫" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "new-task", onClick: beginNew, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PlusIcon, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "新任务" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "search-box", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SearchIcon, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: search, onChange: (event) => setSearch(event.target.value), placeholder: "搜索共同经历" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section-title", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "最近" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: tasks.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-list", children: [
        tasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskItem, { task, selected: task.id === selectedId, onSelect: () => void selectTask(task.id) }, task.id)),
        tasks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "task-list-empty", children: "第一段共同经历，会从这里开始。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-footer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => void window.molly.stopAll(), disabled: activeCount === 0, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StopIcon, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "停止全部" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: activeCount > 0 ? `${activeCount} 个进行中` : "此刻很安静" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "conversation-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "composer", onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-inner", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-foot", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedId ? "补充当前任务" : "创建新的任务" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: !draft.trim() || sending, "aria-label": "发送", children: sending ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "send-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowIcon, {}) })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ArtifactPanel, { snapshot })
  ] });
}
const root = document.getElementById("root");
if (!root) throw new Error("Molly root element is missing.");
